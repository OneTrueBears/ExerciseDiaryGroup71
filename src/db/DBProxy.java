...
public class DBProxy {
	...
	public ArrayList<SessionView> getSessionView(){
	 ...
	 public void uploadSession(Session es){
		  //(SESSION ID, PERSON_ID, DURATION_MIN, DATE_TIME, HEALTH_CONDITION, PERFORMANCE, PURPOSE_NOTE, LATE_TIPS, SPECTATORS, AIR_CONDITIONS, WEATHER_TEMP, WEATHER_TYPE, IS_OUTDOOR)
